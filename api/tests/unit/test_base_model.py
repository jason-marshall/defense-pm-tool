...
class TestSoftDeleteModel(Base, SoftDeleteMixin):
    ...
    __tablename__ = "test_soft_deletes"
...
class TestBaseModel:
    ...
    def test_manual_ids_are_unique(self) -> None:
        ...
        id1, id2 = uuid4(), uuid4()
        model1 = TestModel(id=id1, name="test1")
        model2 = TestModel(id=id2, name="test2")
...
class TestToDict:
    ...
    def test_to_dict_basic(self) -> None:
        ...
        test_id = uuid4()
        model = TestModel(id=test_id, name="test_name")
...
class TestSoftDeleteMixin:
    ...
    def test_active_filter(self) -> None:
        ...
        filter_expr = TestSoftDeleteModel.active_filter()
    ...
    def test_deleted_filter(self) -> None:
        ...
        filter_expr = TestSoftDeleteModel.deleted_filter()
        # Verify it creates a valid SQLAlchemy expression
        assert filter_expr is not None
